package me.leon.multithread.inter_thread_communication;
 ...
 */
public class MatricesMultiplierApplication {
    private static final String INPUT_FILE = "./out/matrices_input.txt";
    ...
    private static class ThreadSafeQueue {
        ...
        public synchronized void add(MatricesPair matricesPair) {
            // FIXME : 이 주석을 풀면 queue 의 CAPACITY 를 최대값으로 back-pressure 가 작동됨
